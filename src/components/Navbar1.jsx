      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex md:items-center md:space-x-6 text-lg font-medium">
            ...
            <Link to="/shop" className="text-gray-800 hover:text-purple-600 transition">Services</Link>
            <Link to="/features" className="text-gray-800 hover:text-purple-600 transition">Projects</Link>
            ...
            <Link to="/blog" className="text-gray-800 hover:text-purple-600 transition">Contact</Link>
          </div>

          {/* Login/Profile Section */}
          <div className="hidden md:flex md:items-center space-x-2">
            {/* <span className="text-xl">&#128100;</span> */}
            <Link to="/login" className="text-gray-800 hover:text-purple-600 transition">+91 1234567890</Link>
          </div>
